...
ALTER TABLE STUDENT
	ADD CONSTRAINT STUD_ADDRESS_FK FOREIGN KEY (STUD_POSTAL_CODE)
		REFERENCES ADDRESS (POSTAL_CODE);

ALTER TABLE STUDENT
	ADD CONSTRAINT STUD_HALL_FK FOREIGN KEY (HALL_NUMBER)
		REFERENCES HALL (HALL_NUMBER);

ALTER TABLE STUDENT
	ADD CONSTRAINT STUD_PROGRAM_FK FOREIGN KEY (PROG_NUMBER)
		REFERENCES PROGRAM (PROG_NUMBER);

ALTER TABLE PROGRAM_STRUCTURE
    DROP CONSTRAINT PROGRAM_STRUCTURE_PK;

ALTER TABLE PROGRAM_STRUCTURE
    ALTER COLUMN PS_PROG_NUMBER CHAR(5) NOT NULL;

ALTER TABLE PROGRAM_STRUCTURE
    ADD CONSTRAINT PROGRAM_STRUCTURE_PK PRIMARY KEY(PS_PROG_NUMBER,PS_COURSE_CODE);

ALTER TABLE PROGRAM_STRUCTURE
    ADD CONSTRAINT PROGRAM_STRUCTURE_PK PRIMARY KEY(PS_PROG_NUMBER,PS_COURSE_CODE);

ALTER TABLE PROGRAM_STRUCTURE
    ADD CONSTRAINT PROGST_PROG_FK FOREIGN KEY (PS_PROG_NUMBER)
        REFERENCES PROGRAM (PROG_NUMBER);

ALTER TABLE PROGRAM_STRUCTURE
    ADD CONSTRAINT PROGST_COURSE_FK FOREIGN KEY (PS_COURSE_CODE)
        REFERENCES COURSE (CRS_CODE);

ALTER TABLE DEPARTMENT
    ADD CONSTRAINT DEPTHEAD_STAFF_FK FOREIGN KEY (DEPT_HEAD)
        REFERENCES STAFF (STAFF_NUMBER);

ALTER TABLE DEPARTMENT
    ADD CONSTRAINT DEPTDIV_DIVISION_FK FOREIGN KEY (DEPT_DIV_NUMBER)
